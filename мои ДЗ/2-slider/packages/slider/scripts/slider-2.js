...
let images = {
    ...
    moveImageLeft() {
        this.slides[this.previousIdx].classList.add('move-slide-left');
        setTimeout(() => {
            this.slides[this.previousIdx].classList.remove('move-slide-left');
            this.slides[this.previousIdx].classList.add('hidden-slide');
        }, 500);

        // this.slides[this.previousIdxLeft].classList.add('returnRight');
    },
    moveImageRight() {
        this.slides[this.previousIdx].classList.add('move-slide-right');
        setTimeout(() => {
            this.slides[this.previousIdx].classList.remove('move-slide-right');
            this.slides[this.previousIdx].classList.add('hidden-slide');
        }, 500);
    },
